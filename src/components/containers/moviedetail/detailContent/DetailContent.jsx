      ...
      setDataMedia([
        {
          ...
          video: movieDetailData?.videos.results[0]?.key,
          isVideo: false,
        },
      ]);
    ...
    <>
      ...
      <div className="social__scroller">
        <ListHorizontal
          ...
          listItemTab={LIST_MEDIA.listMedia}
          itemTabActive={activeMedia}
          onClickTab={handleClickMedia}
        >
          {/* Tabs */}
          <div className="review__content">
                  ...
                  <Card
                    ...
                    image={
                      recommendation.backdrop_path
                        ? `https://www.themoviedb.org/t/p/w250_and_h141_face${recommendation.backdrop_path}`
                        : "https://www.blackrockworkwear.com/themes/blackrock/assets/images/default-video-image.png"
                    }
                    description={recommendation.original_title}
                    borderRadius="8px"
                    isRecommendation
