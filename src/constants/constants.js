...
export const dataLeaderboard = [
  ...
  },
  {
    ...
    title: "fzlins",
    imgAvatar:
      "https://www.themoviedb.org/t/p/w64_and_h64_face/r1KY1E9EPR2YZWqovmslYMLBzjR.jpg",
    countAllTime: 303120,
    countThisWeek: 4120,
    style: {
      widthAllTime: "56%",
...
export const LIST_LOGIN = [
  { content: "Find something to watch on your subscribed streaming services" },
  { content: "Log the movies and TV shows you have watched" },
  {
    content:
      "Keep track of your favourite movies and TV shows and get recommendations from them",
  },
  { content: "Build and maintain a personal watchlist" },
  { content: "Build custom mixed lists (movies and TV)" },
